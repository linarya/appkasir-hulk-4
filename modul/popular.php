<section class="popular-places" id="popular">
        <div class="container-fluid">
            ...
            <div class="owl-carousel owl-theme">
                ...
                <div class="item popular-item">
                    <div class="thumb">
                        <img src="assets/img/popular_item_2.jpg" alt="">
                        <div class="text-content">
                            <h4>Aenean dolor</h4>
                ...
                <div class="item popular-item">
                    <div class="thumb">
                        <img src="assets/img/popular_item_3.jpg" alt="">
                        <div class="text-content">
                            <h4>Nunc at quam</h4>
                ...
                <div class="item popular-item">
                    <div class="thumb">
                        <img src="assets/img/popular_item_4.jpg" alt="">
                        <div class="text-content">
                ...
                <div class="item popular-item">
                    <div class="thumb">
                        <img src="assets/img/popular_item_5.jpg" alt="">
                        <div class="text-content">
                            <h4>Lorem ipsum</h4>
