<footer>
            ...
            <div class="row">
                ...
                <div class="col-md-3">
                    <div class="contact-info">
                        ...
                        <ul>
                            <li><span>Phone:</span><a href="#">012-100-150</a></li>
                            <li><span>Email:</span><a href="#">erlinaraya2@gmail.com</a></li>
                            <li><span>Address:</span><a href="#">travel-lina.co</a></li>
                        </ul>
                    </div>
                    </div>
            </div>
    ...
    <div class="sub-footer">
        <p>Copyright 2023 Company Travel-Lina
    </div>
